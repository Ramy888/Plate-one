...
| | Scans | Pictures | Window |
|---|---|---|---|
| Per device | 8 | 4 | per day |
| Whole deployment | `GLOBAL_CALLS_PER_DAY` (2000) | — | per day |
...
**A refused model call is refunded.** If Gemini errors after the allowance was
taken, the unit goes back. The user should not pay for our failure.
...
| Secret | Without it |
|---|---|
| `ASSEMBLYAI_API_KEY` | No voice session can be opened |
