...
class FoodMatcher {
  ...
  static const _aliases = <String, String>{
    ...
    'tomato': 'salad',
    'tomatoes': 'salad',
    // Everyday foods that now have a catalogue row of their own, plus the
    // names people use for them. "pancakes" used to match nothing, which left
    // the plate empty, the advice impossible and the picture drawn from
    // whatever the person was talked into listing instead.
    'pancake': 'pancakes',
    'waffle': 'pancakes',
    'waffles': 'pancakes',
    'crepe': 'pancakes',
    ...
    'lasagna': 'pasta',
    'shakshuka': 'eggs',
    'avocado': 'avocado_food',
    'guacamole': 'avocado_food',
    'smoothie': 'fruit',
    'juice': 'fruit',
    'turkey': 'chicken',
    'duck': 'chicken',
