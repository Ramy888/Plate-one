/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d0a925f3a540bbcbd560a7e8c3573352)
...
interface __BaseEnv_Env {
	...
	GLOBAL_VOICE_SESSIONS_PER_DAY: "100";
	PROMO_USES_PER_CODE: "1";
	ALLOWED_ORIGINS: "https://plateone.pages.dev,https://plate-one.pages.dev,http://localhost:8080,http://localhost:8000";
	GEMINI_API_KEY: string;
	ASSEMBLYAI_API_KEY: string;
	PROMO_CODES: string;
	QUOTA: DurableObjectNamespace<import("./src/index").QuotaCounter>;
	GLOBAL_CAP: DurableObjectNamespace<import("./src/index").GlobalCap>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "QuotaCounter" | "GlobalCap";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MODEL_CHAT" | "MODEL_CHAT_IMAGE" | "AI_GATEWAY_ID" | "CF_ACCOUNT_ID" | "PLATES_PER_DAY" | "PREVIEWS_PER_DAY" | "VOICE_SESSIONS_PER_DAY" | "GLOBAL_CALLS_PER_DAY" | "GLOBAL_VOICE_SESSIONS_PER_DAY" | "PROMO_USES_PER_CODE" | "ALLOWED_ORIGINS" | "GEMINI_API_KEY" | "ASSEMBLYAI_API_KEY" | "PROMO_CODES">> {}
}
